...
void interview() {
	...
	if (intr == 1) {
		...
		if (intr3 == 1) {
			accuracy += 10;
			cout << "I was sitting with sir and discussig bussiness matters " << endl;
...
int main() {
	cout << "\t\t\t\t========================================" << endl;
	cout << "\t\t\t\tWelcome to Secrets Behind The Study Door" << endl;
	cout << "\t\t\t\t========================================" << endl;
	cout << "\tThe famous real state owner, MR.SHAH JAHAN has been found dead in his study room this evening" << endl;
	cout << "\t\t\t\tYou've been appointed to investigate the case" << endl;
	cout << "\t\t\t\tShow your skills and find out the culprit!!!" << endl;

	//INTRO TO GAME
	start();

	//INVESTIGATING DIFFERENT AREAS OF MANSION
	for (int i = 1; i <= 3; i++) {
		cout << "\t\t\t\tInvestigation#" << i << endl;
		clues();
	}
	cout << "=========================================================" << endl;
	//INTERVIEWING DIFFERENT SUSPECTS
	for (int i = 1; i <= 3; i++) {
		cout << "\t\t\t\tInvestigation#" << i << endl;
		interview();
		cout << "\t\t\t\t========================" << endl;
	...
	culprit();
	if (accuracy > 80) cout << "Rank: Master Detective ";
	else if (accuracy > 50) cout << "Rank: Amateur Sleuth ";
	else cout << "Rank: Clueless Rookie ";
